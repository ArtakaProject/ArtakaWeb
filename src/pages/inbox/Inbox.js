...
<div className="flex-1 w-full">
      ...
      <div >
{/* emailRow */}
        <div onClick={() => navigate(pathPage, { replace: true })} className="flex w-full items-center h-12.5 border-b border-solid border-gray-400 cursor-pointer z-999">
            ...
            <div className="flex-initial max-w-3xl items-center text-xs">
                ...
                Follow me!!
                <span className="font-normal text-gray-700">Click the following button to follow me.</span>
                </h4>
            </div>
            <p className="pr-15 text-xs font-bold">9am</p>
        </div>

        <div onClick={() => navigate(pathPage, { replace: true })} className="flex items-center h-12.5 border-b border-solid border-gray-400 cursor-pointer z-999">
            <div className="flex-none w-15">
                <Checkbox />
                <IconButton>
                    <StarBorderOutlinedIcon/>
