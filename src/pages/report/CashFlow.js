                            ...
                            <div class="px-4 py-5 bg-white sm:p-6 divide-y divide-gray-700">
                                <div>
                                    ...
                                    <div class="grid grid-cols-2 gap-2">
                                        <label class="block text-sm font-extrabold text-gray-700">SALDO AWAL</label>
                                        <label class="block text-sm font-extrabold text-gray-700" style={{ textAlign: 'right' }}>Rp 2.496.051</label>
                                        <label class="block text-sm font-medium text-gray-700">Saldo Awal Sebelum Periode</label>
                                        <label class="block text-sm font-medium text-gray-700 mb-10" style={{ textAlign: 'right' }}>Rp 2.496.051</label>
                                        <label class="block text-sm font-extrabold text-gray-700">PEMASUKAN</label>
                                        <label class="block text-sm font-extrabold text-gray-700" style={{ textAlign: 'right' }}>Rp 0</label>
                                    </div>
                                </div>
                                <div>
                                    <div class="grid grid-cols-2 gap-2">
                                            <label class="block text-sm font-extrabold text-gray-700">TOTAL PEMASUKAN</label>
                                            <label class="block text-sm font-extrabold text-gray-700" style={{ textAlign: 'right' }}>Rp 0</label>
                                    </div>
                                </div>
                                <div>
                                    <div class="grid grid-cols-2 gap-2">
                                            <label class="block text-sm font-extrabold text-gray-700 my-3">PENGELUARAN</label>
                                            <label class="block text-sm font-extrabold text-gray-700 my-3" style={{ textAlign: 'right' }}>Rp 0</label>
                                    </div>
                                </div>
                                <div class="grid grid-cols-2 gap-2">
                                        <label class="block text-sm font-extrabold text-gray-700">TOTAL PENGELUARAN</label>
                                        <label class="block text-sm font-extrabold text-gray-700" style={{ textAlign: 'right' }}>Rp 0</label>
                                        <label class="block text-sm font-extrabold text-gray-700">ARUS KAS</label>
                                        <label class="block text-sm font-extrabold text-gray-700" style={{ textAlign: 'right' }}>Rp 0</label>
                                        <label class="block text-sm font-extrabold text-gray-700">SALDO AKHIR</label>
                                        <label class="block text-sm font-extrabold text-gray-700" style={{ textAlign: 'right' }}>Rp 2.496.051</label>
                                </div>
                            </div>
                        </div>
