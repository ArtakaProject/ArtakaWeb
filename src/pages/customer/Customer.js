...
export default function Customer() {
    ...
    return (
        <>
            <PageHeading actionTitle={"Add Customer"} onNewClick={() => history.push('/customer/add')}/>
                                ...
                                <tbody className="bg-white divide-y divide-gray-200">
                                    {customer && customer.map((cust) =>(
                                        <tr key={cust.id}>
                                            ...
                                            <td className="px-6 py-4 whitespace-nowrap">
                                                <div className="text-sm text-gray-900">{cust.email}</div><br/>
                                                <div className="text-sm text-gray-900">{cust.phone}</div>
                                            </td>
                                            <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500"></td>
                                            <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{cust.create_dtm}</td>
