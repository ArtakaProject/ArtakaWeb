  ...
  return useRoutes ([
    ...
    },
    {
      ...
      children: [
        ...
        { path: 'product', element: isLoggedIn ? <Products />: <Navigate to="/artaka/signin"/> },
        { path: 'product/add', element: isLoggedIn ? <AddProduct /> : <Navigate to="/artaka/signin"/> },
        { path: 'product/edit', element: isLoggedIn ? <EditProduct /> : <Navigate to="/artaka/signin"/> },
